...
The **Windows Package Manager** is an [open source client](https://github.com/Unity-Billal-mesloub/winget-cli) designed for command-line usage. If you are interested in exploring private repositories offering private Windows Package Manager package hosting, see [private repositories](doc/private/README.md).
